...
public class ARLoader extends Activity
{
    ...
    private static final String NATIVE_LIB_SAMPLE = "ARLoader";    
    private static final String NATIVE_LIB_QCAR = "QCAR"; 

    // Our OpenGL view:
    private ARLoaderGLView mGlView;
    ...
    // Our renderer:
    private ARLoaderRenderer mRenderer;
    ...
    {   
        ...
        {
            QCAR.setInitParameters(ARLoader.this, mQCARFlags);
        ...
        protected void onPostExecute(Boolean result)
        {
            ...
            else
            {
                ...
                AlertDialog dialogError = new AlertDialog.Builder(ARLoader.this).create();
   ...
   /** Called when the activity will start interacting with the user.*/
    ...
    {        
        ...
        mGlView = new ARLoaderGLView(this);
        mGlView.init(mQCARFlags, translucent, depthSize, stencilSize);
        
        mRenderer = new ARLoaderRenderer();
